...
def medRecom(symptoms,
    ...
    for model_name , model in models.items():
        ...
        models_name_matrix.append({
            model_name:str(np.array2string(cm,separator=', '))
        })
    ...
    # Remove any extra characters, if any
    total_number_of_unique_disease = len(df['prognosis'].unique())
    predicted_disease = given_predicted_value(user_symptoms)
   
    desc, pre, med, die, wrkout = helper(predicted_disease)
    return [prognosis , desc, pre, med, die, wrkout,predicted_disease,models_name_matrix,total_number_of_unique_disease]
